    ...
    <>
      ...
      <section className="section" id="services">
        <div className="section-visual-wrap">
          <SectionVisual shape="octahedron" color="#1c1c28" rimColor="#7c3aed" rimColor2="#3b82f6" />
        </div>
      ...
      <section className="section" id="about">
        <div className="section-visual-wrap">
          <SectionVisual shape="dodecahedron" color="#1a1a22" rimColor="#3b82f6" rimColor2="#7c3aed" />
        </div>
        <div className="container">
      ...
      <section className="section" id="why">
        <div className="section-visual-wrap">
          <SectionVisual shape="tetrahedron" color="#221a14" rimColor="#ff6a3d" rimColor2="#3b82f6" />
        </div>
        <div className="container">
...
function StartProject() {
  ...
  return (
    <section className="start-hero">
      <div className="section-visual-wrap">
        <SectionVisual shape="box" color="#1c1c24" rimColor="#3b82f6" rimColor2="#ff6a3d" />
      </div>
